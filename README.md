# Portfólio Pessoal | SPA

Este é o repositório do meu Portfólio Pessoal, um projeto construído como uma **Single Page Application (SPA)** de alta performance, com design moderno e facilidade de manutenção. Originalmente moldado a partir de um template de código aberto, o sistema foi extensamente refatorado para entregar um site conciso de página única.
...
Execute o seguinte comando em seu terminal para baixar as bibliotecas base:
